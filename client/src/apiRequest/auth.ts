...
const authApiRequets = {
    ...
    logoutFromNextClientToNextServer :(force?:boolean|undefined) => http.post<MessageResType>('/api/auth/logout' ,{}, { baseUrl:''}),
